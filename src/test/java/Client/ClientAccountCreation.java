...
public class ClientAccountCreation extends Base_File {
	...
	@Test
	public void AccountCreationWithFreeTrailClassPack() {

		ClientSignUp a = new ClientSignUp(driver);
		a.FirstName().sendKeys("Aasia");
		a.LastName().sendKeys("Mustakeem");
	...
	@Test
	public void AccountCreationWithClassPackPurchase() {
		ClientSignUp a = new ClientSignUp(driver);
