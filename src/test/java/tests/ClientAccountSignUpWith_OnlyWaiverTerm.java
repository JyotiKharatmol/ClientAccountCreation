...
public class ClientAccountSignUpWith_OnlyWaiverTerm extends BaseTest
{
	...
	@Test(priority=7)
	public void SignUp_AccountCreationWithOnlyWaiverTerm_PurchaseClassAndMemPack_WithMemPackPromoCode()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
