...
public class ClientAccountSignUp extends BaseTest
{
	...
	@Test(priority=7)
	public void SignUp_AccountCreationWith_PurchaseClassAndMemPack_WithMemPackPromoCode()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
	...
	@Test(priority=9)
	public void SignUp_AccountCreationWith_PurchaseClassAndMemPackWith_NoPromoCode()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
	...
	@Test(priority=10)
	public void SignUp_AccountCreationWith_PurchaseClassAndUnlimitedMemPackWith_MemPromoCodeAndSelfCard()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
		...
		Assert.assertEquals(a.confirmERelationship().getText(), "Sister");
		Assert.assertEquals(a.actualGrandTotalName_ClassAndMem().getText(), "You Pay Today");
		Assert.assertEquals(a.actualGrandTotalAmount_ClassAndMem().getText(), "$2.50");
		a.enterMemPackPromoCode();
		a.promoCodeApply();
		Assert.assertEquals(a.promoCodeAppliedMessage().getText(), "Your promo code has been applied successfully!");
		Assert.assertEquals(a.promoCodeName_ClassAndMem().getText(), "Promo-(mempack23)");
		Assert.assertEquals(a.promoCodeAmount_ClassAndMem().getText(), "-$0.40");
		Assert.assertEquals(a.grandTotalName_ClassAndMem_AfterDiscount().getText(), "You Pay Today");
		Assert.assertEquals(a.grandTotalAmount_ClassAndMem_AfterDiscount().getText(), "$2.10");
		a.sameAsClientDetailsCheck();
		Assert.assertEquals(a.cardHolderFirstName().getAttribute("value"), "Rose");
		Assert.assertEquals(a.cardHolderLastName().getAttribute("value"), "Lavelle");
		Assert.assertEquals(a.cardHolderEmail().getAttribute("value"), "jyoti.kharatmol+"+randomInt+"@azularc.com");
	...
	@Test(priority=11)
	public void SignUp_AccountCreationWith_PurchaseClassAndUnlimitedMemPackWith_ClassPackPromoCodeAndSelfCard()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
		...
		Assert.assertEquals(a.promoCodeAmount_ClassAndMem().getText(), "-$0.50");
		Assert.assertEquals(a.grandTotalName_ClassAndMem_AfterDiscount().getText(), "You Pay Today");
		Assert.assertEquals(a.grandTotalAmount_ClassAndMem_AfterDiscount().getText(), "$2.00");
		a.sameAsClientDetailsCheck();
		Assert.assertEquals(a.cardHolderFirstName().getAttribute("value"), "Rose");
		Assert.assertEquals(a.cardHolderLastName().getAttribute("value"), "Lavelle");
		Assert.assertEquals(a.cardHolderEmail().getAttribute("value"), "jyoti.kharatmol+"+randomInt+"@azularc.com");
	...
	@Test(priority=12)
	public void SignUp_AccountCreationWith_PurchaseClassAndUnlimitedMemPackWith_NoPromoCodeAndSelfCard()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
	...
	@Test(priority=13)
	public void SignUp_AccountCreationWith_PurchaseFreeClassPackAndMemPackWith_MemPromoCodeAndSelfCard()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
		...
		Assert.assertEquals(a.promoCodeAmount_ClassAndMem().getText(), "-$0.80");
		Assert.assertEquals(a.grandTotalName_ClassAndMem_AfterDiscount().getText(), "You Pay Today");
		Assert.assertEquals(a.grandTotalAmount_ClassAndMem_AfterDiscount().getText(), "$1.20");
		a.sameAsClientDetailsCheck();
		Assert.assertEquals(a.cardHolderFirstName().getAttribute("value"), "Rose");
		Assert.assertEquals(a.cardHolderLastName().getAttribute("value"), "Lavelle");
		Assert.assertEquals(a.cardHolderEmail().getAttribute("value"), "jyoti.kharatmol+"+randomInt+"@azularc.com");
	...
	@Test(priority=14)
	public void SignUp_AccountCreationWith_PurchaseFreeClassPackAndMemPackWith_NoPromoCodeAndSelfCard()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
	...
	@Test(priority=15)
	public void SignUp_AccountCreationWith_PurchaseClassPackAndFreeFirstMonthMemPackWith_ClassPackPromoCodeAndSelfCard()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
		...
		Assert.assertEquals(a.confirmERelationship().getText(), "Sister");
		Assert.assertEquals(a.actualGrandTotalName_ClassAndMem().getText(), "You Pay Today");
		Assert.assertEquals(a.actualGrandTotalAmount_ClassAndMem().getText(), "$1.50");
		a.enterSessionPackPromoCode();
		a.promoCodeApply();
		Assert.assertEquals(a.promoCodeAppliedMessage().getText(), "Your promo code has been applied successfully!");
		Assert.assertEquals(a.promoCodeName_ClassAndMem().getText(), "Promo-(yog247)");
		Assert.assertEquals(a.promoCodeAmount_ClassAndMem().getText(), "-$0.50");
		Assert.assertEquals(a.grandTotalName_ClassAndMem_AfterDiscount().getText(), "You Pay Today");
		Assert.assertEquals(a.grandTotalAmount_ClassAndMem_AfterDiscount().getText(), "$1.00");
		a.sameAsClientDetailsCheck();
		Assert.assertEquals(a.cardHolderFirstName().getAttribute("value"), "Rose");
		Assert.assertEquals(a.cardHolderLastName().getAttribute("value"), "Lavelle");
		Assert.assertEquals(a.cardHolderEmail().getAttribute("value"), "jyoti.kharatmol+"+randomInt+"@azularc.com");
	...
	@Test(priority=16)
	public void SignUp_AccountCreationWith_PurchaseClassPackAndFreeFirstMonthMemPackWith_NoPromoCodeAndSelfCard()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
	...
	@Test(priority=17)
	public void SignUp_AccountCreationWith_PurchaseClassPackAndDifferentFirstMonthMemPackWith_MemPromoCodeAndSelfCard()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
	...
	@Test(priority=18)
	public void SignUp_AccountCreationWith_PurchaseClassPackAndDifferentFirstMonthMemPackWith_ClassPackPromoCodeAndSelfCard()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
	...
	@Test(priority=19)
	public void SignUp_AccountCreationWith_PurchaseClassPackAndDifferentFirstMonthMemPackWith_NoPromoCodeAndSelfCard()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
