...
public class ClientAccountSignUpWith_NoTerm extends BaseTest
{
	...
	@Test(priority=7)
	public void SignUp_AccountCreationWith_NoTerm_PurchaseClassAndMemPack_WithMemPackPromoCode()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.signUpLink();
		a.enterFirstName();
