...
public class ClientAccountCreationWith_OnlyWaiverTerm extends BaseTest
{
	...
	@Test(priority=1)
	public void ClientAccountCreationWith_OnlyWaiverTerm_NoPackage()
	{
		...
		a.saveAndContinue3();
		a.NoStudioTermAdded_DefaultPoliciesTermCheckbox();
	...
	@Test(priority=2)
	public void ClientAccountCreationWith_OnlyWaiverTerm_FreeTrailPack()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.DoYouHaveAcustomerAccount();
		a.selectSessionOnCalendar();
	...
	@Test(priority=3)
	public void ClientAccountCreationWith_OnlyWaiverTerm_PurchaseClassPack() 
	{
	ClientSignUp a = new ClientSignUp(driver);
	a.DoYouHaveAcustomerAccount();
	a.selectSessionOnCalendar();
	...
	@Test(priority=4)
	public void ClientAccountCreationWith_OnlyWaiverTerm_PurchaseMemPack()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.DoYouHaveAcustomerAccount();
		a.selectSessionOnCalendar();
	...
	@Test(priority=5)
	public void ClientAccountCreationWith_OnlyWaiverTerm_PurchaseUnlimitedMem()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.DoYouHaveAcustomerAccount();
		a.selectSessionOnCalendar();
	...
	@Test(priority=6)
	public void ClientAccountCreationWith_OnlyWaiverTerm_FreeFirstMonthMemPack()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.DoYouHaveAcustomerAccount();
		a.selectSessionOnCalendar();
	...
	@Test(priority=7)
	public void ClientAccountCreationWith_OnlyWaiverTerm_PurchaseClassAndMemPack_WithMemPackPromoCode()
	{
		ClientSignUp a = new ClientSignUp(driver);
		a.DoYouHaveAcustomerAccount();
		a.selectSessionOnCalendar();
	...
	@Test(priority=8)
	public void ClientAccountCreationWith_OnlyWaiverTerm_PurchaseClassAndMemPack_ClassPackPromoCode()
	{
